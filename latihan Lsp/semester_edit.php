				...
				if(!empty($kd_semester))
					{
						...
						if(edit_data_sms($kd_semester,$ket_semester,$thn_semester))
						{
        ...
        <form class="needs-validation" action="" method="post">
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control" id="firstName" name="kd_semester" placeholder="" value="<?= $kd_semester ?>"  required>
                    
                </div>
                <div class="col-md-12 mb-3">
                    <label for="lastName">Keterangan semester</label>
                    <input type="text" class="form-control" id="lastName" name="ket_semester" placeholder=""  value="<?= $ket_semester ?>" required>
                </div>
                <div class="col-md-12 mb-3">
