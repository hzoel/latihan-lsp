	...
	require_once "view/layout/header.php";
        ...
        if(isset($_GET['id']))
        {
             ...
             while ($row = mysqli_fetch_assoc($get))
             {
                ...
                $nm_mhs          = $row['nm_mhs'];
                $tempat_lhr_mhs  =  $row['tempat_lhr_mhs'];
                $agama           =  $row['agama'];
                $tgl_lhr_mhs     = $row['tgl_lhr_mhs'];
                $jenis_klmn_mhs  =  $row['jenis_klmn_mhs'];
                $tgl_msk_mhs        =  $row['tgl_msk_mhs'];
                $kd_status_mhsnama           = $row['kd_status_mhs'];
				...
				if(!empty($nim_mahasiswa))
					{
						...
						if(update_mhs($nim_mahasiswa,$kd_prodi,$nm_mhs,$tempat_lhr_mhs,$agama, $tgl_lhr_mhs,$jenis_klmn_mhs,$tgl_msk_mhs,$kd_status_mhsnama,$alamat_mhs,$tlp_mhs))
						{
        ...
        <form class="needs-validation" action="" method="post">
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control" id="firstName" name="nim_mahasiswa" placeholder="" value="<?= $nim_mahasiswa?>" required>
                    
                </div>
                <div class="col-md-12 mb-3">
                    <label for="lastName">Kode Prodi</label>
                    <input type="text" class="form-control" id="lastName" name="kd_prodi" placeholder="" value="<?= $kd_prodi?>" required>
                </div>
                <div class="col-md-12 mb-3">
                    <label for="lastName">Nama Mahasiswa</label>
                    <input type="text" class="form-control" id="lastName" name="nm_mhs" placeholder="" value="<?= $nm_mhs?>" required>
                </div>
                <div class="col-md-12 mb-3">
                    <label for="firstName">Tempat Lahir</label>
                    <input type="text" class="form-control" id="firstName" name="tempat_lhr_mhs" placeholder="" value="<?= $tempat_lhr_mhs?>" required>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="date" class="form-control" id="firstName" name="tgl_lhr_mhs" placeholder="" value="<?= $tgl_lhr_mhs?>" required>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="date" class="form-control" id="lastName" name="tgl_msk_mhs" placeholder="" value="<?= $tgl_msk_mhs?>" required>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control" id="lastName" name="alamat_mhs" placeholder="" value="<?= $alamat_mhs?>" required>
                </div>
                <div class="col-md-12 mb-3">
                    <label for="lastName">tlpn</label>
                    <input type="text" class="form-control" id="lastName" name="tlp_mhs" placeholder="" value="<?= $tlp_mhs?>" required>
                </div>
                <div class="col-md-12 mb-3">
