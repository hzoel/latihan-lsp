				...
				if(!empty($kd_matkul))
					{
						...
						if(edit_data_krs($kd_matkul,$thn_semester,$nim_mhs,$kd_prodi,$kd_kelas,$id))
						{
        ...
        <form class="needs-validation" action="" method="post">
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control" id="firstName" name="kd_matkul" placeholder="" value="<?= $kd_matkul ;?>"  required>
                    
                </div>
                <div class="col-md-12 mb-3">
                    <label for="lastName">Tahun Semester</label>
                    <input type="text" class="form-control" id="lastName" name="thn_semester" placeholder="" value="<?= $thn_semester ;?>" required>
                </div>
                <div class="col-md-12 mb-3">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control" id="lastName" name="kd_kelas" placeholder="" value="<?= $kd_kelas ;?>" required>
                </div>
